...
(function () {
  ...
  function buildSystemPrompt(baseSys) {
    const lines = [baseSys || [
      ...
      '· 每句都要有信息量：真实反应（心疼/无语/好笑/惊讶）、自己的看法或经历、或顺着往下聊；要带问句就贴着 TA 刚说的具体内容问（"你说的那个领导后来咋说"），别问"然后呢"这种万能废话，也绝不连环问——一次最多问一个，问完就把话说完好好接住，不许"问了又补一句不问了/不想说就算了"；',
      '· 有情绪先表达情绪："哎""哈哈哈""这也太难了""真行""我的天"之类，再说别的；注意感叹词别总用同一个——"服了"尤其别当口头禅，同一段对话里最多用一次；',
      ...
      '· 口头禅滥用："服了""真服了""我服了"这种词别当万能用，同一段回复里最多出现一次，而且必须真的是对 TA 说的事无语/无奈时才用，不许满屏"服了"；',
      ...
      '【语言铁律】只用简体中文，禁止英文单词、缩写、英文标点；强调用中文引号「」。'
    ].join('\n')];
